...
public readonly struct BiomeSpawnDefinition(OurBiome biomeType, string path, BiomeArea area, string searchName, SpawnType spawnType)
{
    public OurBiome BiomeType { get; } = biomeType;
